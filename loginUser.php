...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <p class="login-box-msg">Mulai sesi dirimu sebagai <b class="text-primary">Pasien</b></p>
        ...
        <div class="text-center mt-3">Apakah kamu Dokter? <a href="login.php"><span class="text-success"><b>Login Sini</b></span></a>
    </div>
    <!-- /.card-body -->
  </div>
  <!-- /.card -->
